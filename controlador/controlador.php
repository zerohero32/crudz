<?php
   ...
   if(isset($_POST["usuarioRegistroz"])){

                $datosControlador = array(  "usuario" => $_POST["usuarioRegistroz"],
                                            "nombre" => $_POST["nombreRegistro"],
                                            "email" => $_POST["emailRegistro"],
                                            "password" => $_POST["passwordRegistro"],
                                        );
                ...
                if($respuesta == "success"){
                    ...
                    header("location:index.php?action=zzz");
                    //header("location:index.php?action=zzz#signup-agile");
        ...
        public function vistaUsuariosControlador(){
            ...
            foreach($respuesta as $row => $item){
                ...
                echo    '<tr>
                                ...
                                <td>'.$item["email"].'</td>
                                <td>'.$item["password"].'</td>
                                <td><a class="btn btn-info" href="index.php?action=editar&id='.$item["id"].'">Editar</a></td>
                                <td>
